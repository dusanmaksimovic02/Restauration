...
namespace backend.Migrations
{
    ...
    [Migration("20240608150901_verzijaNova")]
    partial class verzijaNova
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.StavkaUMeniju", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.Hrana", b =>
                {
                    b.HasBaseType("backend.Models.StavkaUMeniju");
            ...
            modelBuilder.Entity("backend.Models.Hrana", b =>
                {
                    b.HasOne("backend.Models.StavkaUMeniju", null)
                        .WithOne()
                        .HasForeignKey("backend.Models.Hrana", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("backend.Models.Pice", b =>
                {
                    b.HasOne("backend.Models.StavkaUMeniju", null)
                        .WithOne()
                        .HasForeignKey("backend.Models.Pice", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
